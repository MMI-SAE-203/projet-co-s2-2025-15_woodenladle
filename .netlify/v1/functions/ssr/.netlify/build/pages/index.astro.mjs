...
const Mathis = "/_astro/Mathis.DBdsPiJk.webp";

const Valentine = "/_astro/Valentine.nXZf6STO.webp";

const Ethan = "/_astro/Ethan.CVyQtTgG.webp";
...
Notre équipe
</h2> <div class="flex flex-col lg:grid lg:grid-cols-3 font-montserrat space-y-20" data-astro-cid-j7pv25f6> <div class="space-y-5 flex flex-col items-center" data-astro-cid-j7pv25f6> <img${addAttribute(Valentine, "src")} alt="Valentine GUILLOT" class="w-40 h-40" data-astro-cid-j7pv25f6> <div class="space-y-2 text-center" data-astro-cid-j7pv25f6> <p class="" data-astro-cid-j7pv25f6>Valentine GUILLOT</p> <p class="text-pink font-bold text-xl" data-astro-cid-j7pv25f6>Designeuse</p> <p data-astro-cid-j7pv25f6>valentine.guillot@edu.univ-fcomte.fr</p> </div> </div> <div class="space-y-5 flex flex-col items-center" data-astro-cid-j7pv25f6> <img${addAttribute(Mathis, "src")} alt="Mathis GUELLATI" class="w-40 h-40" data-astro-cid-j7pv25f6> <div class="space-y-2 text-center" data-astro-cid-j7pv25f6> <p class="" data-astro-cid-j7pv25f6>Mathis GUELLATI</p> <p class="text-pink font-bold text-xl" data-astro-cid-j7pv25f6>Développeur</p> <p data-astro-cid-j7pv25f6>mathis.guellati@edu.univ-fcomte.fr</p> </div> </div> <div class="space-y-5 flex flex-col items-center" data-astro-cid-j7pv25f6> <img${addAttribute(Ethan, "src")} alt="Ethan HENNEQUIN-DE-MEYER" class="w-40 h-40" data-astro-cid-j7pv25f6> <div class="space-y-2 text-center" data-astro-cid-j7pv25f6> <p class="" data-astro-cid-j7pv25f6>Ethan HENNEQUIN-DE-MEYER</p> <p class="text-pink font-bold text-xl" data-astro-cid-j7pv25f6>Communicant</p> <p class="w-2/3 mx-auto" data-astro-cid-j7pv25f6>ethan.hennequin--de_meyer@edu.univ-fcomte.fr</p> </div> </div> </div> </div> </div>  ${renderScript($$result2, "C:/Users/mathi/github/projet-co-s2-2025-15_woodenladle/src/pages/index.astro?astro&type=script&index=0&lang.ts")} ` })}`;
